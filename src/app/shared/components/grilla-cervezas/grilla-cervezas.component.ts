...
import { FormCervezaComponent } from '../form-cerveza/form-cerveza.component';
import { DialogModule } from 'primeng/dialog';
import { CommonModule } from '@angular/common';

@Component({
  selector: 'app-grilla-cervezas',
  imports: [
    CommonModule,
    FormsModule,
    ButtonModule,
  ...
  templateUrl: './grilla-cervezas.component.html',
  styleUrl: './grilla-cervezas.component.scss'
})
export class GrillaCervezasComponent implements OnInit {
